...
global show_array ; Name of the function

segment .data

text db "IEEE754            Scientific Decimal", 10, 0
show db "0x%016lx %-18.13e", 10, 0
...
show_array: ; Name of the function
...
push qword 0
mov rax, 0
mov rdi, text ; IEEE754 Scientific Decimal
call printf
pop rax

; Show the array in both IEEE754 and scientific decimal by loop through each qword in the array
mov r13, 0 ; Counter
begin_loop:
    cmp r13, r14
    je end_loop
    ...
    push qword 0
    mov rax, 1 ; Indicate 1xmm register will be printed
    mov rdi, show ; "0x%016lx %-18.13e"
    mov rsi, [r15 + r13 * 8] ; Move the qword of array into rsi
    movsd xmm0, [r15 + r13 * 8] ; Convert the qword to float form
    call printf ; Call external function prinf
    pop rax
